...
- React handles large amounts of data and renders the data quicker by changing the UI instantly.

1. Describe component state.

- State is an object that holds some information of a component that can change over time. This is managed within the componet, like variables in a function.

1. Describe props.

- Props is an object that gets passed to the component (like function params)

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

- Application state change tht happens outside the function - not just a react specific term.
